...
## A token is a piece of data recieved from the server. This string is what is utilized to validate if a user is logged in or has permission to access a page/object

- [ ] What steps can you take in your web apps to keep your data secure?

## utlizing authentication

- [ ] Describe how web servers work.

## Hold and serve information when propperly requested

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

## Get (Request Data) Put (Edit Data ) Post (submit new data) Delete (Remove Data)
